...
DatabaseManager::DatabaseManager(){
    ...
    QSqlQuery query6("CREATE TABLE if not exists Depense (id INTEGER PRIMARY KEY AUTOINCREMENT, titre TEXT NOT NULL, date TEXT NOT NULL, montant REAL NOT NULL, idCompte INTEGER NOT NULL, emailPayeur TEXT NOT NULL)");
